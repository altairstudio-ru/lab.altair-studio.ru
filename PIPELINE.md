...
## Контентная часть: фон-подложка Modern Tech (2026-09-21, сделано)
- Задача заказчика: «контентную часть сделать как фон с инженерной сеткой в теме Modern» → уточнение: **не сетка, а фон**
- Замер канона (живой altair-studio.ru/themes, тема №3): контент лежит на подложках surface #1E293B / subtle #162032, сверху blueprint-сетка, поверх #0F172A; вертикальных рамок-колец вокруг блоков нет
